...
<div id="page_wrap">
     <div id="header">
          ...
          <a href="http://www.shanfanhuang.com" target="_self" title="Home"><?php bloginfo('description'); ?></a>
             </div>
		<div class="clear"></div>
                    

        <!--end of tagline, start with main menu -->             


             <div id="menu">
               <div class="menu-category">
                <ul>
            <li><a href="http://www.shanfanhuang.com/showcase.html">SHOWCASE</a></li>
            <li><a href="http://www.shanfanhuang.com/more_works/visual_communication/more_works_visual_com.html">MORE WORKS</a></li>
            <li><a href="http://www.shanfanhuang.com/about_shanfan.html">ABOUT SHANFAN</a></li>
            <li>BLOG</li>
                </ul>
               </div>
                 <div class="clear"></div>
...
<!-- end of main menu, start with blog navi menu -->             
