...
<br>
<img onclick=Cbold() src="ubbpic/bold.gif" width="23" height="22" alt="粗体" border="0"> 
<img onclick=Citalic() src="ubbpic/italicize.gif" width="23" height="22" alt="斜体" border="0"> 
<img onclick=Cunder() src="ubbpic/underline.gif" width="23" height="22" alt="下划线" border="0"> 
<img onclick=Ccenter() src="ubbpic/center.gif" width="23" height="22" alt="居中" border="0"> 
<img onclick=Curl() src="ubbpic/icon_editor_url.gif" width="23" height="22" alt="超级连接" border="0"> 
<img onclick=Cemail() src="ubbpic/email.gif" width="23" height="22" alt="Email连接" border="0"> 
<img onclick=Cimage() src="ubbpic/image.gif" width="23" height="22" alt="图片" border="0"> 
<img onclick=Cswf() src="ubbpic/swf.gif" width="23" height="22" alt="Flash图片" border="0"> 
<img onclick=Cquote() src="ubbpic/quote.gif" width="23" height="22" alt="引用" border="0"> 
<img onclick=Cdir() src="ubbpic/Shockwave.gif" width="23" height="22" alt="Shockwave文件" border="0"> 
<img onclick=Crm() src="ubbpic/rm.gif" width="23" height="22" alt="realplay视频文件" border="0"> 
<img onclick=Cwmv() src="ubbpic/mp.gif" width="23" height="22" alt="Media Player视频文件" border="0"> 
<img onclick=Cmov() src="ubbpic/qt.gif" width="23" height="22" alt="QuickTime视频文件" border="0"> 
<IMG onclick=Cfly() height=22 alt=飞行字 src="ubbpic/fly.gif" width=23 border=0> 
<IMG onclick=Cmarquee() height=22 alt=移动字 src="ubbpic/move.gif" width=23 border=0> 
<IMG onclick=Cguang() height=22 alt=发光字 src="ubbpic/glow.gif" width=23 border=0> 
<IMG onclick=Cying() height=22 alt=阴影字 src="ubbpic/shadow.gif" width=23 border=0>