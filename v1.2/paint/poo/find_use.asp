...
<%
Dim admin_name,findname
if user_name <> "" then admin_name = user_name
findname=Request.QueryString("name")
set book = Server.CreateObject("ADODB.Recordset")
book.ActiveConnection = MM_may_user_STRING
book.Source = "SELECT *  FROM book  WHERE admin_name = '"&admin_name&"' and name = '"&findname&"'  ORDER BY toptime DESC"
book.CursorType = 0
        ...
        <tr> 
          <td width="60%" height="2"> 
            <div align="left"><a href="index.asp">涂鸦板主页</a> <a href="javascript:location.reload()">刷新页面</a> 
              ...
              <a href="good_Topic.asp">精华作品</a></div>
          </td>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr> 
                <td><img src="../bbsimages/name.gif" width="48" height="18"> <b><%=(book.Fields.Item("name").Value)%></b> 
                  ...
                  &nbsp;&nbsp;<img src="../bbsimages/time.gif" width="44" height="20"><%=(book.Fields.Item("posttime").Value)%>&nbsp;&nbsp; 
                  <%if Session("admin_name")=user_name or  Session("admin_pass")=user_password then %>
