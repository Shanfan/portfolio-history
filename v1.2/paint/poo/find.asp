...
word=Request.QueryString("find")
set book = Server.CreateObject("ADODB.Recordset")
book.ActiveConnection = MM_may_user_STRING
book.Source = "SELECT *  FROM book  WHERE admin_name = '"&admin_name&"'and name like '%" & word & "%'  ORDER BY toptime DESC"
book.CursorType = 0
...
%>
        ...
        <tr> 
          <td width="60%" height="10"> 
            <div align="left"><a href="index.asp">涂鸦板主页</a> <a href="javascript:location.reload()">刷新页面</a> 
              <a href="bbssize.asp" target="_blank">目前状态</a> <a href="login.asp">管理进入</a> 
              <a href="allpic.asp">图片模式</a><font color="#FF0000"></font><font color="#FF0000"></font> 
              <a href="good_Topic.asp">精华作品</a> <font color="#FF0000"> <a href="login.asp?out=ture"> 
              </a></font></div>
          </td>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
        <tr> 
          <td colspan="3">&nbsp;管理员：<%=DoWhiteSpace(nichen)%>&nbsp;&nbsp;&nbsp; &nbsp;版主： 
            <%
startrw = 0
        ...
        <tr> 
          <td colspan="2" bgcolor="<%=titlebg%>" height="20"> 
            <table width="80%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> &nbsp;<img src="../bbsimages/red_folder.gif" width="18" height="12"> 
        ...
        <tr> 
          <td colspan="2" bgcolor="<%=bg_color%>" valign="top"> 
            <table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr> 
                <td><img src="../bbsimages/name.gif" width="48" height="18"> <b><%=(book.Fields.Item("name").Value)%></b> 
                  <%if book.Fields.Item("oicq").Value<>""and  Isnumeric(book.Fields.Item("oicq").Value)then %>
                  <a href="http://search.tencent.com/cgi-bin/friend/user_show_info?ln=<%=(book.Fields.Item("oicq").Value)%>" target="_blank"><img src="../bbsimages/qq.gif" alt="<%=(book.Fields.Item("oicq").Value)%>" border="0"></a> 
                  <%end if %>
                  ...
                  &nbsp;&nbsp;<img src="../bbsimages/time.gif" width="44" height="20"> 
                  <%=(book.Fields.Item("posttime").Value)%>&nbsp;&nbsp; &nbsp;&nbsp; 
                  <%if Session("admin_name")=user_name or  Session("admin_pass")=user_password then %>
...
%>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td valign="top" width="57%" height="123"> 
...
wend
 %>
              ...
              <tr> 
                <td valign="bottom" width="57%" height="15"> 
